      ...
      <div className="flex justify-between items-center ">
        {props.from === 'videoSection' ? (
          <div className="flex gap-8 items-center">
            <button onClick={() => { navigate('/dashboard/myCourse'); }}  className="border border-neutral-70 rounded-lg px-1.5 py-1">
              <img
                src={arrowUp}
                alt="link icon"
            ...
            <h3 className="h3 dark:text-neutral-10">Your Courses</h3>
          </div>
        ) : (
