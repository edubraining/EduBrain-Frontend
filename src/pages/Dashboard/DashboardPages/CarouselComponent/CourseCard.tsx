        ...
        <div className="px-4 pb-2">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              {details.overallProgress === "100" ? (<p className="text-base dark:text-neutral-10 text-neutral-100 font-normal font-Roboto">
                Course Completed
              </p>) : (
                <p className="text-base dark:text-neutral-10 text-neutral-100 font-normal font-Roboto">
                  {details.lastRead}
            ...
            <div className="flex justify-between items-center">
              ...
              {details.overallProgress === "100" ? (
                <button className="flex gap-2 items-center justify-center text-neutral-10 text-base px-9 py-3 bg-neutral-55 cursor-not-allowed rounded-xl">
                  Completed
                </button>
              ) : (
                <button
...
>
  {details.isEnrolled ? 'Enrolled' : 'Enroll Now!'}
              ...
              <button
                className={`text-neutral-10 text-base px-4 py-3 rounded-xl w-1/2 ${details.isEnrolled
                    ? 'bg-neutral-55 cursor-not-allowed'
                    : 'bg-primary-60 hover:bg-blue-700 transition duration-300'
                  }`}
                disabled={details.isEnrolled}
